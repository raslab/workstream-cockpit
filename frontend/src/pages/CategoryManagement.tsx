    ...
    <div>
      ...
      {isCreating ? (
        <div className="mb-6 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
          <h3 className="mb-4 text-lg font-semibold text-gray-900">Create New Category</h3>
          <form onSubmit={handleCreate}>
            <div className="mb-4">
              ...
              <input
                ...
                autoFocus
              />
              <div className="mt-1 text-xs text-gray-500">{newCategoryName.length}/100 characters</div>
            </div>
