  ...
  return (
    <section className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-300 dark:text-gray-400">
      ...
      <fieldset>
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-300 dark:text-gray-400">
        ...
        <div className="mt-4 space-y-3">
          {themeOptions.map((option) => (
            <label
              key={option.value}
              className="flex cursor-pointer items-start gap-3 rounded-md border border-gray-200 p-4 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-700/60 dark:hover:bg-gray-700"
            >
              <input
                type="radio"
                name="color-theme"
                ...
                className="mt-1 h-4 w-4 border-gray-300 text-primary-600 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-900 dark:text-primary-400"
              />
              <span>
                <span className="block text-sm font-medium text-gray-900 dark:text-gray-100">
                  {option.label}
                </span>
                <span className="block text-sm text-gray-600 dark:text-gray-300 dark:text-gray-400">
                  {option.description}
                </span>
              </span>
            </label>
