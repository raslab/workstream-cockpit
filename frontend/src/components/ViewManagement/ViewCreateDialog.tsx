  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 dark:bg-opacity-70">
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
        <h3 className="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Create New View</h3>

        <div className="mb-4">
          <label htmlFor="view-name" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
            View Name
          </label>
          <input
            id="view-name"
